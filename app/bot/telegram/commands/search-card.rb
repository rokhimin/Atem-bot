class Search
  ...
  MONSTER_TYPES = [
    ...
    "Flip Tuner Effect Monster", "Tuner Monster", "Toon Monster", "Gemini Monster",
    "Spirit Monster", "Union Effect Monster", "Union Tuner Effect Monster", "Ritual Monster",
    "Ritual Effect Monster", "Fusion Monster", "Synchro Monster", "Synchro Pendulum Effect Monster",
    "Synchro Tuner Monster", "XYZ Monster", "XYZ Pendulum Effect Monster", "Pendulum Effect Monster",
    "Pendulum Flip Effect Monster", "Pendulum Normal Monster", "Pendulum Tuner Effect Monster",
    "Pendulum Effect Fusion Monster", "Link Monster"
  ].freeze
  ...
  TYPE_DESCRIPTIONS = {
    ...
    "Flip Tuner Effect Monster" => lambda { |race| "[ #{race} / Flip / Tuner / Effect ]" },
    ...
    "Union Tuner Effect Monster" => lambda { |race| "[ #{race} / Union / Tuner / Effect ]" },
    "Ritual Monster" => lambda { |race| "[ #{race} / Ritual ]" },
    "Ritual Effect Monster" => lambda { |race| "[ #{race} / Ritual / Effect ]" },
    "Fusion Monster" => lambda { |race| "[ #{race} / Fusion / Effect ]" },
    "Synchro Monster" => lambda { |race| "[ #{race} / Synchro / Effect ]" },
    "Synchro Pendulum Effect Monster" => lambda { |race| "[ #{race} / Synchro / Pendulum / Effect ]" },
    "Synchro Tuner Monster" => lambda { |race| "[ #{race} / Synchro / Tuner / Effect ]" },
    "XYZ Monster" => lambda { |race| "[ #{race} / XYZ / Effect ]" },
    "XYZ Pendulum Effect Monster" => lambda { |race| "[ #{race} / XYZ / Pendulum / Effect ]" },
    "Pendulum Effect Monster" => lambda { |race| "[ #{race} / Pendulum / Effect ]" },
    "Pendulum Flip Effect Monster" => lambda { |race| "[ #{race} / Pendulum / Flip / Effect ]" },
    "Pendulum Normal Monster" => lambda { |race| "[ #{race} / Pendulum ]" },
    "Pendulum Tuner Effect Monster" => lambda { |race| "[ #{race} / Pendulum / Tuner / Effect ]" },
    "Pendulum Effect Fusion Monster" => lambda { |race| "[ #{race} / Pendulum / Effect / Fusion ]" },
